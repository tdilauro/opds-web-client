...
describe("OPDSDataAdapter", function () {
    ...
    it("extracts facet groups", function () {
        ...
        chai_1.expect((_l = facet1) === null || _l === void 0 ? void 0 : _l.href).to.equal("href1");
        ...
        chai_1.expect((_q = facet2) === null || _q === void 0 ? void 0 : _q.href).to.equal("href2");
        ...
        chai_1.expect((_u = facet3) === null || _u === void 0 ? void 0 : _u.href).to.equal("href3");
    });
    it("extracts search link", function () {
        ...
        chai_1.expect((_a = collection.search) === null || _a === void 0 ? void 0 : _a.url).to.equal(searchLink.href);
    });
