...
function isIndirect(link) {
    return !!(link.indirectType &&
        link.type === "application/atom+xml;type=entry;profile=opds-catalog");
}
exports.STREAMING_MEDIA_LINK_TYPE = "text/html;profile=http://librarysimplified.org/terms/profiles/streaming-media";
function useDownloadButton(link, title) {
    ...
    var fulfill = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!isIndirect(link)) return [3 /*break*/, 2];
    ...
    var downloadLabel = isIndirect(link) && link.indirectType === exports.STREAMING_MEDIA_LINK_TYPE
        ? "Read Online"
