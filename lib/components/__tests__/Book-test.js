...
describe("Book", function () {
    ...
    describe("getMediumSVG function", function () {
        ...
        var getMediumSVG;
        beforeEach(function () {
            wrapper = enzyme_1.shallow(React.createElement(Book_1.default, { book: book, updateBook: updateBook }));
        ...
        it("returns a component with the appropriate svg and label for the medium input", function () {
            chai_1.expect(enzyme_1.mount(getMediumSVG("http://bib.schema.org/Audiobook")).text()).to.equal("Audio/Headphone Icon Audio");
        });
        it("returns a component with the appropriate svg but no label for the medium input", function () {
            chai_1.expect(enzyme_1.mount(getMediumSVG("http://bib.schema.org/Audiobook", false)).text()).to.equal("Audio/Headphone Icon ");
        });
    });
